  ...
  async function setup() {
    ...
    const myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: dataTemps.single_data_col
      },
      options: {
          onClick: (e) => {
  ...
  async function getData() {
    ...
    single_data[0] = all_data[single];
        ...
        console.log(all_date2[single]);
     const single_data_col = [];
    single_data_col[0] = all_date2[single];

    return { dates, all_data, RFID, all_date2, weights, single_data, single_data_col};
  }
